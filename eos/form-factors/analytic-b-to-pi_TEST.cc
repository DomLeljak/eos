    ...
    public:
        ...
        virtual void run() const
        {
             ...
             */
            {
                ...
                // Ftil NLO, tw3
                TEST_CHECK_NEARLY_EQUAL( 0.8548, ff_no_rescale.Ftil_nlo_tw3(-10.0), 1. * eps);
                TEST_CHECK_NEARLY_EQUAL( 1.1018, ff_no_rescale.Ftil_nlo_tw3( -1.0), 1. * eps);
                ...
                TEST_CHECK_NEARLY_EQUAL( 0.2071, ff_no_rescale.f_0(-10.0), 10. * eps);
                TEST_CHECK_NEARLY_EQUAL( 0.2398, ff_no_rescale.f_0( -5.0), 10. * eps);
                TEST_CHECK_NEARLY_EQUAL( 0.2735, ff_no_rescale.f_0( -1.0), 10. * eps);
                ...
                // FT NLO, tw2
                TEST_CHECK_NEARLY_EQUAL( 0.4544, ff_no_rescale.FT_nlo_tw2(-10.0), 1. * eps);
                TEST_CHECK_NEARLY_EQUAL( 0.6467, ff_no_rescale.FT_nlo_tw2( -1.0), 1. * eps);
                TEST_CHECK_NEARLY_EQUAL( 0.6750, ff_no_rescale.FT_nlo_tw2(  0.0), 1. * eps);
                TEST_CHECK_NEARLY_EQUAL( 0.7048, ff_no_rescale.FT_nlo_tw2(  1.0), 1. * eps);
                TEST_CHECK_NEARLY_EQUAL( 0.8380, ff_no_rescale.FT_nlo_tw2(  5.0), 1. * eps);
                TEST_CHECK_NEARLY_EQUAL( 0.9908, ff_no_rescale.FT_nlo_tw2( 10.0), 1. * eps);

                // FT NLO, tw3
                TEST_CHECK_NEARLY_EQUAL(-0.3735, ff_no_rescale.FT_nlo_tw3(-10.0), 1. * eps);
                TEST_CHECK_NEARLY_EQUAL(-0.7036, ff_no_rescale.FT_nlo_tw3( -1.0), 1. * eps);
                TEST_CHECK_NEARLY_EQUAL(-0.7694, ff_no_rescale.FT_nlo_tw3(  0.0), 1. * eps);
                TEST_CHECK_NEARLY_EQUAL(-0.8457, ff_no_rescale.FT_nlo_tw3(  1.0), 1. * eps);
                TEST_CHECK_NEARLY_EQUAL(-1.3123, ff_no_rescale.FT_nlo_tw3(  5.0), 1. * eps);
                TEST_CHECK_NEARLY_EQUAL(-2.7711, ff_no_rescale.FT_nlo_tw3( 10.0), 1. * eps);
